...
const Dashboard = () => {
  ...
  useEffect(() => {
    ...
    const fetchInitialBalances = async () => {
      try {
        const response = await axios.get(
          `https://pennywise-backend-gywb.onrender.com/api/settings/initial-currencies/${user_id}`
        );
        setInitialBalances({
    ...
    const fetchIncomeBySource = async () => {
      try {
        const response = await axios.get(
          `https://pennywise-backend-gywb.onrender.com/api/transactions/income-by-source/${user_id}`
        );
        setIncomeBySource({
    ...
    const fetchExpensesBySource = async () => {
      try {
        const response = await axios.get(
          `https://pennywise-backend-gywb.onrender.com/api/transactions/expenses-by-source/${user_id}`
        );
        setExpensesBySource({
